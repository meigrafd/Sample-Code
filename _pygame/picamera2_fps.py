...
class PiVideoStream(object):
    ...
    def get_fps(self):
        self.stream_fps.stop()
        return self.stream_fps.fps()
...
def main():
    ...
    try:
        ...
        buttons = [
                    Button(text='Start stream', callback=vs.start, _font='droidsans', fontsize=42, pos=(30, 0), screen=window),
                    Button(text='Stop stream', callback=vs.stop, _font='droidsans', fontsize=42, pos=(30, 60), screen=window),
                  ]
        ...
        while True:
            ...
            if (debugFPS == True and vs.running == True) or debugFPS == 'always':
                ...
                print('STREAM: %.3f fps' % vs.get_fps())
